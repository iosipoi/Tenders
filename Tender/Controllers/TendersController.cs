...
namespace Tender.Controllers
{
    public class TendersController : Controller
    {
        ...
        public TendersController(TenderContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,StartPrice,FinalPrice,CreatedOn,CreatedBy,CPVCode,Status")] TenderDetails tender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,StartPrice,FinalPrice,CreatedOn,CreatedBy,CPVCode,Status")] TenderDetails tender)
        {
            if (id != tender.Id)
            {
                return NotFound();

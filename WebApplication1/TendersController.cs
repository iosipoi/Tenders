...
namespace WebApplication1
{
    public class TendersController : Controller
    {
        ...
        public TendersController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,StartPrice,FinalPrice,CreatedOn,CreatedBy,CPVCode,Status")] Tender tender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,StartPrice,FinalPrice,CreatedOn,CreatedBy,CPVCode,Status")] Tender tender)
        {
            if (id != tender.Id)
            {
                return NotFound();
